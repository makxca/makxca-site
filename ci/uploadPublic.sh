...
scp -P $SSH_DEPLOY_PORT -r ./site/public $SSH_DEPLOY_ADDRESS:~/
ssh $SSH_DEPLOY_ADDRESS -p $SSH_DEPLOY_PORT "sudo -S rm -rf /var/www/public"
ssh $SSH_DEPLOY_ADDRESS -p $SSH_DEPLOY_PORT "sudo -S mv ~/public /var/www/public"
echo SUCCESS
